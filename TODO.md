...
| **Использований `any`**      | 15+ (только сервисы) | **29** (весь проект)      | **0**             | 🔴 Open |
...
| App.tsx строк                | 1947                 | **24** ✅                | < 50               | ✅ Done   | —    |
| server/index.js строк        | 893                  | **52** ✅                | < 100              | ✅ Done   | —    |
| `any` типов                  | 15+ (только сервисы) | **29** (весь проект)     | **0**              | 🔴 P0     | 9.1  |
| isMounted паттернов          | 26                   | **0** ✅                 | 0                  | ✅ Done   | —    |
...
| ----- | ----------------------------------------------- | --------- | --------- | ---- | --------- |
| TD-17 | Устранить 29 оставшихся `any` типов             | 🔴 P0     | Средняя   | 9.1  | ❌ Открыт |
